...
class UsuarioCreateSchema(BaseModel):
    ...
    contrato: str = Field(
        ..., description="Tipo o número de contrato del usuario", examples=["Contrato a término indefinido"]
    )
    correo: EmailStr | None = Field(
        None, description="Correo electrónico de contacto", examples=["juan.perez@example.com"]
    )
    telefono: str | None = Field(
        None, description="Número de teléfono de contacto. Fijo 7 digitos, celular 10 digitos", examples=["123456789"]
    )
    ...
    departamento: str = Field(..., description="Departamento asociado al usuario")
...
class UsuarioUpdateSchema(BaseModel):
    ...
    cargo: str | None = Field(None, description="Cargo que desempeña el usuario")
    municipio: str | None = Field(None, description="Municipio asociado al usuario")
    departamento: str | None = Field(None, description="Departamento asociado al usuario")
