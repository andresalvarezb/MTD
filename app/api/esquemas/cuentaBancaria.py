...
class CuentaBancariaResponseSchema(BaseModel):
    ...
    numero_certificado: str = Field(..., description="Número del certificado bancario asociado")
    ...
    observaciones: str = Field(..., description="Observaciones o notas adicionales sobre la cuenta bancaria")
