...
class CuentaPorPagarORM(Base):
    ...
    estado_aprobacion_cuenta_usuario: Mapped[str | None] = mapped_column(String(45), nullable=True)
    estado_cuenta_por_pagar: Mapped[str | None] = mapped_column(String(45), nullable=True)
    valor_cuenta_cobro: Mapped[DECIMAL] = mapped_column(DECIMAL(18, 2), nullable=False, default=0.0)
    total_descuentos: Mapped[DECIMAL] = mapped_column(DECIMAL(18, 2), nullable=False, default=0.0)
    total_a_pagar: Mapped[DECIMAL] = mapped_column(DECIMAL(18, 2), nullable=False, default=0.0)
